...
export default function Home() {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    setMessage(
      "Account created. Check your email to confirm your account, then log in here."
    );
    setMode("login");
    setLoading(false);
  }
    ...
    <main className="min-h-screen bg-slate-950 px-5 py-8 sm:px-6 sm:py-10">
      <div className="mx-auto grid min-h-[calc(100vh-4rem)] max-w-6xl overflow-hidden rounded-[2rem] bg-white shadow-2xl lg:grid-cols-2">
        <section className="hidden bg-gradient-to-br from-blue-950 via-slate-950 to-slate-900 p-12 text-white lg:flex lg:flex-col lg:justify-between">
          <div>
            <div className="text-3xl font-black tracking-tight">Hospire</div>
          ...
          <div>
            ...
            <p className="mt-6 max-w-md text-lg leading-8 text-slate-300">
              Create one Hospire account, build your profile, and showcase
              real photos and videos of your hospitality work.
            </p>
          </div>
        ...
        <section className="p-6 sm:p-10 lg:p-14">
          ...
          <div className="mx-auto max-w-xl">
            ...
            <p className="mt-8 text-sm font-bold uppercase tracking-widest text-blue-700">
              {mode === "login" ? "Welcome back" : "Join Hospire"}
            </p>

            <h2 className="mt-3 text-4xl font-black tracking-tight text-slate-950">
              {mode === "login" ? "Continue your profile." : "Build your profile."}
            </h2>

            <p className="mt-3 text-slate-500">
              {mode === "login"
                ? "Log in and continue where you left off."
                : "One account takes you from signup to your own profile."}
            </p>
            ...
            <form onSubmit={handleSubmit} className="mt-8 space-y-5">
                ...
                <>
                  <div className="grid gap-3 sm:grid-cols-2">
                    ...
                    >
                      ...
                      <span className="mt-2 block font-black">Looking for work</span>
                    </button>
                    <button
                      type="button"
                    ...
                    >
                      <span className="text-xl">🏨</span>
                      <span className="mt-2 block font-black">Hiring talent</span>
                    </button>
                  </div>
              ...
              {mode === "signup" && (
                <label className="flex gap-3 text-sm text-slate-600">
                  ...
                  />
                  I agree to Hospire&apos;s terms and understand that employer verification may be required.
                </label>
              )}
            ...
            {mode === "login" && (
              <button
                type="button"
                className="mt-5 block w-full text-sm font-bold text-blue-700 hover:text-blue-800"
