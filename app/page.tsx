        ...
        <section className="bg-[#f6f1e7] p-6 text-[#17130e] sm:p-10 lg:p-14">
          ...
          <div className="mx-auto max-w-xl">
            <div className="flex rounded-xl border border-[#d8cdbb] bg-[#eee7da] p-1">
              <button type="button" onClick={() => switchMode("login")} className={`flex-1 rounded-xl px-4 py-3 text-sm font-black transition ${mode === "login" ? "bg-[#fffdf8] text-[#17130e] shadow-sm" : "text-[#6f675b]"}`}>Log in</button>
              <button type="button" onClick={() => switchMode("signup")} className={`flex-1 rounded-xl px-4 py-3 text-sm font-black transition ${mode === "signup" ? "bg-[#fffdf8] text-[#17130e] shadow-sm" : "text-[#7b7265]"}`}>Create account</button>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              {error && <div className="rounded-xl bg-[#f7ebe7] px-4 py-3 text-sm font-semibold text-[#8b3f31]">{error}</div>}{message && <div className="rounded-xl bg-[#edf3ec] px-4 py-3 text-sm font-semibold text-[#35533c]">{message}</div>}
            ...
            {mode === "login" && <button type="button" className="mt-5 block w-full text-sm font-bold text-[#9a7337] hover:text-[#6f5128]" onClick={() => router.push("/login")}>Forgot password?</button>}
          </div>
        </section>
      </div>
      <FeaturedTalent />
